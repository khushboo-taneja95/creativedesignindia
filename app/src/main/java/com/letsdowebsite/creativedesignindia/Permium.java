...
public class Permium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.permium );
    ...
    public void WebAction() {
        ...
        mWebview.loadUrl( "https://cdifootwearsolution.com/premium-customer/" );
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(Permium.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mWebview.canGoBack()) {
                    ...
                    Intent intent = new Intent(Permium.this, USA.class);
