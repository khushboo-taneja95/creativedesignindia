    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( Membership.this, Splash.class );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                mWebview.loadUrl( "http://www.creativedesignindia.in/membership/payu/form.php" );
                break;
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            private void initInstances() {
                ...
                menu2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent( Membership.this, Download.class );
                        startActivity( i );
                ...
                drawerToggle = new ActionBarDrawerToggle(
                        Membership.this, drawerLayout, R.string.navigation_drawer_open, R.string.navigation_drawer_close );
                            ...
                            public boolean onNavigationItemSelected(MenuItem menuItem) {
                                ...
                                switch (id) {
                                    case R.id.nav_membership:
                                        startActivity( new Intent( Membership.this, Membership.class ) );
                                        break;
                                    case R.id.nav_supplier:
                                        startActivity( new Intent( Membership.this, Supplier.class ) );
                                        break;
                                    case R.id.nav_login:
                                        startActivity( new Intent( Membership.this, Login.class ) );
                                        break;
