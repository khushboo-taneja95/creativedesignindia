...
public class Men extends AppCompatActivity {
    ...
    public void WebAction() {
        ...
        mWebview.loadUrl( "https://cdifootwearsolution.com/mens/" );
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(Men.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mWebview.canGoBack()) {
                    ...
                    Intent intent = new Intent(Men.this, USA.class);
