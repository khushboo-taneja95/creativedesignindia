...
public class Mens extends AppCompatActivity {
    ...
    public void WebAction() {
        ...
        mWebview.loadUrl( "https://cdifootwearsolution.com/premium-customer/mens/" );
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(Mens.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mWebview.canGoBack()) {
                    ...
                    Intent intent = new Intent(Mens.this, USA.class);
