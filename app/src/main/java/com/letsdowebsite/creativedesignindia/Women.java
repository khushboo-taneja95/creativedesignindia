...
public class Women extends AppCompatActivity {
    ...
    public void WebAction() {
        ...
        mWebview.loadUrl( "https://cdifootwearsolution.com/womens/" );
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(Women.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mWebview.canGoBack()) {
                    ...
                    Intent intent = new Intent(Women.this, USA.class);
