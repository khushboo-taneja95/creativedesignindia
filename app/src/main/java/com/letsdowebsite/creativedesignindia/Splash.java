    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen( GravityCompat.START )) {
            ...
            if (back_pressed + 2000 > System.currentTimeMillis()) {
                ...
                Toast.makeText( this, "Are You Sure Want To Exit App!", Toast.LENGTH_SHORT ).show();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                mWebview.loadUrl( "https://creativedesignindia.in/" );
                break;
            ...
            private void initInstances() {
                ...
                menu2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent( Splash.this, Download.class );
                        startActivity( i );
                ...
                drawerToggle = new ActionBarDrawerToggle(
                        Splash.this, drawerLayout, R.string.navigation_drawer_open, R.string.navigation_drawer_close );
                            ...
                            public boolean onNavigationItemSelected(MenuItem menuItem) {
                                ...
                                switch (id) {
                                    case R.id.nav_membership:
                                        startActivity( new Intent( Splash.this, Membership.class ) );
                                        break;
                                    case R.id.nav_supplier:
                                        startActivity( new Intent( Splash.this, Supplier.class ) );
                                        break;
                                    case R.id.nav_login:
