    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( Supplier.this, Splash.class );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                mWebview.loadUrl( " https://creativedesignindia.in/supplier-categories" );
                break;
            ...
            private void initInstances() {
                ...
                menu2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent( Supplier.this, Download.class );
                        startActivity( i );
                ...
                drawerToggle = new ActionBarDrawerToggle(
                        Supplier.this, drawerLayout, R.string.navigation_drawer_open, R.string.navigation_drawer_close );
                            ...
                            public boolean onNavigationItemSelected(MenuItem menuItem) {
                                ...
                                switch (id) {
                                    case R.id.nav_membership:
                                        startActivity( new Intent( Supplier.this, Membership.class ) );
                                        break;
                                    case R.id.nav_supplier:
                                        startActivity( new Intent( Supplier.this, Supplier.class ) );
                                        break;
                                    case R.id.nav_login:
